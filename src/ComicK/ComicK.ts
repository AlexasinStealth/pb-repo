...
const SOURCE_DOMAIN = "https://comick.io"
...
export class ComicK extends Source {
    ...
    get name(): string { return 'ComicK' }
    get description(): string { return 'First attempt - source with large database' }
    get author(): string { return 'AlexasinStealth' }
